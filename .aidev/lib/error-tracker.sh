#!/bin/bash
# error-tracker.sh - Sistema de rastreamento de erros e tarefas pendentes
# Gerencia erros críticos que não podem ser perdidos
# Anteriormente: backlog.sh (renomeado para evitar conflito com .aidev/plans/backlog/)

BACKLOG_FILE="${BACKLOG_FILE:-.aidev/state/error-tracker.json}"
